...
import React, { ComponentPropsWithRef, ElementRef, forwardRef, useId } from 'react';
      ...
      return (<div>
              ...
              >
                  {items.map((item) => {
                      ...
                      return (
                          <div
                              className="flex items-center st_single_radio_option"
                              key={`${id}-${value}`}
