  ...
  return (
      ...
      >
        ...
        <div
          ...
          >
            <nav
                className="text-white bg-[#522d72]
          @4xl:mx-5 @4xl:rounded-[24px] !rounded-[0px] !mx-[0px] px-[10px] py-[10px]"
            >
              <div className="container ml-auto mr-auto grid grid-cols-[1fr,auto,1fr] items-center  justify-between">
              ...
              >
                { (logoType == "image" ? (
                    <Image src={imageLogo?.src} width={logoW} height={logoH} alt={imageLogo?.altText}/>
                ) : ( logoType == "text" && (
              ...
              <div className="ml-auto flex items-center gap-2 transition-colors duration-300">
                ...
                >
                  ...
                  {cartCount !== undefined && cartCount > 0 && (
                      <span
                          className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-foreground text-xs text-background">
                  {cartCount}
                </span>
                  )}
                </CustomLink>
